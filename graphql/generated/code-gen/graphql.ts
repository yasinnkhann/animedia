...
export type EpisodeDetailsRes = {
  ...
  crew?: Maybe<Array<ShowsCrewModel>>;
  episode_number?: Maybe<Scalars['Int']['output']>;
  guest_stars?: Maybe<Array<ShowsCastModel>>;
...
export type GameCharacter = {
  ...
  games: Array<Scalars['ID']['output']>;
  gender?: Maybe<Scalars['Int']['output']>;
  id: Scalars['ID']['output'];
  mugShotUrl?: Maybe<Scalars['String']['output']>;
  mug_shot?: Maybe<Scalars['ID']['output']>;
...
export type GameCompany = {
  __typename?: 'GameCompany';
  country?: Maybe<Scalars['String']['output']>;
  description?: Maybe<Scalars['String']['output']>;
  developed?: Maybe<Array<Scalars['ID']['output']>>;
  id: Scalars['ID']['output'];
  logo?: Maybe<Scalars['ID']['output']>;
  name: Scalars['String']['output'];
  published?: Maybe<Array<Scalars['ID']['output']>>;
};
...
export type GamePreview = {
  __typename?: 'GamePreview';
  game: Scalars['ID']['output'];
  id: Scalars['ID']['output'];
  name?: Maybe<Scalars['String']['output']>;
...
export type GameResult = {
  ...
  platforms?: Maybe<Array<Scalars['ID']['output']>>;
  ...
  themes?: Maybe<Array<Scalars['ID']['output']>>;
...
export type MovieDetailsRes = {
  ...
  poster_path?: Maybe<Scalars['String']['output']>;
  production_companies: Array<MovieDetailsProdCompany>;
  production_countries: Array<MovieDetailsProdCountry>;
  release_date?: Maybe<Scalars['String']['output']>;
  revenue?: Maybe<Scalars['BigInt']['output']>;
  runtime?: Maybe<Scalars['Int']['output']>;
  spoken_languages: Array<MovieDetailsSpokenLang>;
...
export type MovieReviewsRes = {
  ...
  results: Array<MovieReviewsResult>;
...
export type MoviesCastCrewRes = {
  ...
  cast?: Maybe<Array<MoviesCastModel>>;
  crew?: Maybe<Array<MoviesCrewModel>>;
  id?: Maybe<Scalars['ID']['output']>;
};
...
export type MutationAddGameArgs = {
  ...
  wishlist?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type Query = {
  ...
  popularGames?: Maybe<GamesRes>;
  popularGamesByGenre?: Maybe<GamesRes>;
  ...
  searchGameCharacters?: Maybe<SearchCharacter>;
  ...
  topRatedGames?: Maybe<GamesRes>;
  topRatedGamesByGenre?: Maybe<GamesRes>;
...
export type QueryGameCollectionsArgs = {
  gameId: Scalars['ID']['input'];
};


export type QueryGameCompanyArgs = {
  gameId: Scalars['ID']['input'];
};
...
export type QueryGamePreviewsArgs = {
  gameId: Scalars['ID']['input'];
};
...
export type QueryPopularGamesByGenreArgs = {
...
export type QuerySearchGameCharactersArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  name: Scalars['String']['input'];
};


export type QuerySearchedGamesArgs = {
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
...
export type QuerySimilarGamesArgs = {
  gameIds: Array<Scalars['ID']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type QueryTopRatedGamesByGenreArgs = {
  genreId: Scalars['ID']['input'];
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
};
...
export type ShowDetailsRes = {
  ...
  adult: Scalars['Boolean']['output'];
  backdrop_path?: Maybe<Scalars['String']['output']>;
  created_by: Array<ShowDetailsCreatedBy>;
  ...
  popularity?: Maybe<Scalars['Float']['output']>;
  poster_path?: Maybe<Scalars['String']['output']>;
  production_companies: Array<ShowDetailsProdCompany>;
  production_countries: Array<ShowDetailsCountry>;
  seasons: Array<ShowDetailsSeason>;
  spoken_languages: Array<ShowDetailsSpokenLang>;
  status: Scalars['String']['output'];
  tagline: Scalars['String']['output'];
...
export type ShowReviewRes = {
  ...
  id: Scalars['ID']['output'];
  page: Scalars['Int']['output'];
  results: Array<ShowReviewResult>;
  total_pages: Scalars['Int']['output'];
  total_results: Scalars['Int']['output'];
};
...
export type ShowsCastCrewRes = {
  ...
  cast?: Maybe<Array<ShowsCastModel>>;
  crew?: Maybe<Array<ShowsCrewModel>>;
  id?: Maybe<Scalars['ID']['output']>;
};
...
export type AddMovieMutation = { __typename?: 'Mutation', addMovie?: { __typename?: 'UserMovie', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null } | null };
...
export type AddShowMutation = { __typename?: 'Mutation', addShow?: { __typename?: 'UserShow', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null, current_episode?: number | null } | null };
...
export type AddGameMutation = { __typename?: 'Mutation', addGame?: { __typename?: 'UserGame', id?: string | null, name?: string | null, rating?: number | null, wishlist?: boolean | null } | null };
...
export type UpdateMovieMutation = { __typename?: 'Mutation', updateMovie?: { __typename?: 'UserMovie', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null } | null };
...
export type UpdateShowMutation = { __typename?: 'Mutation', updateShow?: { __typename?: 'UserShow', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null, current_episode?: number | null } | null };
...
export type UpdateGameMutation = { __typename?: 'Mutation', updateGame?: { __typename?: 'UserGame', id?: string | null, name?: string | null, rating?: number | null, wishlist?: boolean | null } | null };
...
export type DeleteMovieMutation = { __typename?: 'Mutation', deleteMovie?: { __typename?: 'UserMovie', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null } | null };
...
export type DeleteShowMutation = { __typename?: 'Mutation', deleteShow?: { __typename?: 'UserShow', id?: string | null, name?: string | null, status?: WatchStatusTypes | null, rating?: number | null, current_episode?: number | null } | null };
...
export type DeleteGameMutation = { __typename?: 'Mutation', deleteGame?: { __typename?: 'UserGame', id?: string | null, name?: string | null, rating?: number | null, wishlist?: boolean | null } | null };
...
export type SearchedGamesQueryVariables = Exact<{
  q: Scalars['String']['input'];
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
}>;
...
export type SearchedGamesQuery = { __typename?: 'Query', searchedGames: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } };
...
export type GameDetailsQuery = { __typename?: 'Query', gameDetails: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } };
...
export type GamePreviewsQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type GamePreviewsQuery = { __typename?: 'Query', gamePreviews?: Array<{ __typename?: 'GamePreview', id: string, game: string, name?: string | null, url?: string | null, video_id?: string | null }> | null };

export type PopularGamesQueryVariables = Exact<{
  page: Scalars['Int']['input'];
  limit: Scalars['Int']['input'];
}>;


export type PopularGamesQuery = { __typename?: 'Query', popularGames?: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } | null };

export type TopRatedGamesQueryVariables = Exact<{
  page: Scalars['Int']['input'];
  limit: Scalars['Int']['input'];
}>;


export type TopRatedGamesQuery = { __typename?: 'Query', topRatedGames?: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } | null };

export type PopularGamesByGenreQueryVariables = Exact<{
  genreId: Scalars['ID']['input'];
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
}>;
...
export type PopularGamesByGenreQuery = { __typename?: 'Query', popularGamesByGenre?: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } | null };

export type TopRatedGamesByGenreQueryVariables = Exact<{
  genreId: Scalars['ID']['input'];
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
}>;
...
export type TopRatedGamesByGenreQuery = { __typename?: 'Query', topRatedGamesByGenre?: { __typename?: 'GamesRes', total_results: number, results: Array<{ __typename?: 'GameResult', id: string, age_ratings?: Array<string | null> | null, alternative_names?: Array<string | null> | null, artworks?: Array<string | null> | null, bundles?: Array<string | null> | null, category?: string | null, checksum?: string | null, collection?: string | null, collections?: Array<string | null> | null, cover?: string | null, coverUrl?: string | null, created_at?: any | null, dlcs?: Array<string | null> | null, expanded_games?: Array<string | null> | null, expansions?: Array<string | null> | null, external_games?: Array<string | null> | null, first_release_date?: any | null, forks?: Array<string | null> | null, franchise?: string | null, franchises?: Array<string | null> | null, game_engines?: Array<string | null> | null, game_localizations?: Array<string | null> | null, game_modes?: Array<string | null> | null, genres?: Array<string> | null, hypes?: number | null, involved_companies?: Array<string | null> | null, keywords?: Array<string | null> | null, language_supports?: Array<string | null> | null, multiplayer_modes?: Array<string | null> | null, name: string, parent_game?: string | null, platforms?: Array<string> | null, player_perspectives?: Array<string | null> | null, ports?: Array<string | null> | null, rating?: number | null, rating_count?: number | null, release_dates?: Array<string | null> | null, remakes?: Array<string | null> | null, remasters?: Array<string | null> | null, screenshots?: Array<string | null> | null, similar_games?: Array<string | null> | null, slug?: string | null, standalone_expansions?: Array<string | null> | null, status?: string | null, storyline?: string | null, summary?: string | null, tags?: Array<string | null> | null, themes?: Array<string> | null, total_rating?: number | null, total_rating_count?: number | null, updated_at?: any | null, url?: string | null, version_parent?: string | null, version_title?: string | null, videos?: Array<string | null> | null, websites?: Array<string | null> | null }> } | null };

export type GameCharactersQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type SearchGameCharactersQuery = { __typename?: 'Query', searchGameCharacters?: { __typename?: 'SearchCharacter', total_results?: number | null, results: Array<{ __typename?: 'GameCharacter', id: string, country_name?: string | null, description?: string | null, games: Array<string>, gender?: number | null, mug_shot?: string | null, mugShotUrl?: string | null, name: string, species?: number | null }> } | null };
...
export type MovieDetailsQuery = { __typename?: 'Query', movieDetails: { __typename?: 'MovieDetailsRes', adult: boolean, backdrop_path?: string | null, homepage: string, id: string, imdb_id?: string | null, original_language: string, original_title: string, overview: string, popularity?: number | null, poster_path?: string | null, release_date?: string | null, revenue?: any | null, runtime?: number | null, status: string, tagline: string, title: string, video?: boolean | null, vote_average?: number | null, vote_count: number, genres: Array<{ __typename?: 'MovieDetailsGenre', id: string, name: string }>, production_companies: Array<{ __typename?: 'MovieDetailsProdCompany', id: string, logo_path?: string | null, name: string, origin_country: string }>, production_countries: Array<{ __typename?: 'MovieDetailsProdCountry', iso_3166_1: string, name: string }>, spoken_languages: Array<{ __typename?: 'MovieDetailsSpokenLang', english_name: string, iso_639_1: string, name: string }> } };
...
export type MoviesInTheatresQuery = { __typename?: 'Query', moviesInTheatres: { __typename?: 'MoviesInTheatresRes', page: string, total_pages: number, total_results: number, dates: { __typename?: 'TheatreDates', maximum: string, minimum: string }, results: Array<{ __typename?: 'MovieResult', adult: boolean, backdrop_path?: string | null, genre_ids?: Array<string | null> | null, id: string, original_language: string, original_title: string, overview: string, popularity?: number | null, poster_path?: string | null, release_date?: string | null, title: string, video?: boolean | null, vote_average?: number | null, vote_count?: number | null }> } };
...
export type ShowDetailsQuery = { __typename?: 'Query', showDetails: { __typename?: 'ShowDetailsRes', adult: boolean, backdrop_path?: string | null, episode_run_time: Array<number | null>, first_air_date?: string | null, homepage: string, id: string, in_production: boolean, languages: Array<string | null>, last_air_date?: string | null, name: string, number_of_episodes: number, number_of_seasons: number, origin_country: Array<string | null>, original_language: string, original_name: string, overview: string, popularity?: number | null, poster_path?: string | null, status: string, tagline: string, type: string, vote_average?: number | null, vote_count?: number | null, created_by: Array<{ __typename?: 'ShowDetailsCreatedBy', id?: string | null, credit_id?: string | null, name?: string | null, gender?: number | null, profile_path?: string | null }>, genres: Array<{ __typename?: 'ShowDetailsGenre', id: string, name: string }>, last_episode_to_air?: { __typename?: 'ShowDetailsLastEpToAir', air_date?: string | null, episode_number: number, id: string, name: string, overview: string, production_code: string, runtime?: number | null, season_number: number, show_id: string, still_path?: string | null, vote_average?: number | null, vote_count: number } | null, networks: Array<{ __typename?: 'ShowDetailsNetwork', id: string, name: string, logo_path?: string | null, origin_country: string }>, production_companies: Array<{ __typename?: 'ShowDetailsProdCompany', id: string, logo_path?: string | null, name: string, origin_country: string }>, production_countries: Array<{ __typename?: 'ShowDetailsCountry', iso_3166_1: string, name: string }>, seasons: Array<{ __typename?: 'ShowDetailsSeason', air_date?: string | null, episode_count: number, id: string, name: string, overview: string, poster_path?: string | null, season_number: number }>, spoken_languages: Array<{ __typename?: 'ShowDetailsSpokenLang', english_name: string, iso_639_1: string, name: string }>, next_episode_to_air?: { __typename?: 'ShowDetailsNextEpToAir', air_date?: string | null, episode_number: number, id: string, name: string, overview: string, production_code: string, runtime?: number | null, season_number: number, show_id: string, still_path?: string | null, vote_average?: number | null, vote_count: number } | null } };
...
export type ShowReviewsQuery = { __typename?: 'Query', showReviews: { __typename?: 'ShowReviewRes', id: string, page: number, total_pages: number, total_results: number, results: Array<{ __typename?: 'ShowReviewResult', author: string, content: string, created_at: string, id: string, updated_at: string, url: string, author_details: { __typename?: 'ShowReviewAuthorDetails', name: string, username: string, avatar_path?: string | null, rating?: number | null } }> } };
...
export type UsersGameQueryVariables = Exact<{
  gameId: Scalars['String']['input'];
}>;


export type UsersGameQuery = { __typename?: 'Query', usersGame?: { __typename?: 'UserGame', id?: string | null, name?: string | null, rating?: number | null, wishlist?: boolean | null } | null };
...
export type UsersGamesQuery = { __typename?: 'Query', usersGames?: Array<{ __typename?: 'UserGame', id?: string | null, name?: string | null, rating?: number | null, wishlist?: boolean | null } | null> | null };
...
export const AddMovieDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddMovie"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movieName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"WatchStatusTypes"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addMovie"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"movieId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}}},{"kind":"Argument","name":{"kind":"Name","value":"movieName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movieName"}}},{"kind":"Argument","name":{"kind":"Name","value":"watchStatus"},"value":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}}]}}]}}]} as unknown as DocumentNode<AddMovieMutation, AddMovieMutationVariables>;
export const AddShowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddShow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"showId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"showName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"WatchStatusTypes"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"currentEpisode"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"showId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"showId"}}},{"kind":"Argument","name":{"kind":"Name","value":"showName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"showName"}}},{"kind":"Argument","name":{"kind":"Name","value":"watchStatus"},"value":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}}},{"kind":"Argument","name":{"kind":"Name","value":"currentEpisode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"currentEpisode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"current_episode"}}]}}]}}]} as unknown as DocumentNode<AddShowMutation, AddShowMutationVariables>;
export const AddGameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddGame"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"wishlist"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"rating"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addGame"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"gameName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameName"}}},{"kind":"Argument","name":{"kind":"Name","value":"wishlist"},"value":{"kind":"Variable","name":{"kind":"Name","value":"wishlist"}}},{"kind":"Argument","name":{"kind":"Name","value":"rating"},"value":{"kind":"Variable","name":{"kind":"Name","value":"rating"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"wishlist"}}]}}]}}]} as unknown as DocumentNode<AddGameMutation, AddGameMutationVariables>;
export const UpdateMovieDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateMovie"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"WatchStatusTypes"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movieRating"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateMovie"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"movieId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}}},{"kind":"Argument","name":{"kind":"Name","value":"watchStatus"},"value":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}}},{"kind":"Argument","name":{"kind":"Name","value":"movieRating"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movieRating"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}}]}}]}}]} as unknown as DocumentNode<UpdateMovieMutation, UpdateMovieMutationVariables>;
export const UpdateShowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateShow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"showId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"WatchStatusTypes"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"showRating"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"currentEpisode"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"showId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"showId"}}},{"kind":"Argument","name":{"kind":"Name","value":"watchStatus"},"value":{"kind":"Variable","name":{"kind":"Name","value":"watchStatus"}}},{"kind":"Argument","name":{"kind":"Name","value":"showRating"},"value":{"kind":"Variable","name":{"kind":"Name","value":"showRating"}}},{"kind":"Argument","name":{"kind":"Name","value":"currentEpisode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"currentEpisode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"current_episode"}}]}}]}}]} as unknown as DocumentNode<UpdateShowMutation, UpdateShowMutationVariables>;
export const UpdateGameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateGame"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"wishlist"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"rating"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateGame"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"wishlist"},"value":{"kind":"Variable","name":{"kind":"Name","value":"wishlist"}}},{"kind":"Argument","name":{"kind":"Name","value":"rating"},"value":{"kind":"Variable","name":{"kind":"Name","value":"rating"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"wishlist"}}]}}]}}]} as unknown as DocumentNode<UpdateGameMutation, UpdateGameMutationVariables>;
export const DeleteMovieDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteMovie"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteMovie"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"movieId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movieId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}}]}}]}}]} as unknown as DocumentNode<DeleteMovieMutation, DeleteMovieMutationVariables>;
export const DeleteShowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteShow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"showId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteShow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"showId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"showId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"current_episode"}}]}}]}}]} as unknown as DocumentNode<DeleteShowMutation, DeleteShowMutationVariables>;
...
export const SearchedGamesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchedGames"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"q"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchedGames"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"q"},"value":{"kind":"Variable","name":{"kind":"Name","value":"q"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<SearchedGamesQuery, SearchedGamesQueryVariables>;
export const GameDetailsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GameDetails"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameDetails"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<GameDetailsQuery, GameDetailsQueryVariables>;
export const GameGenresDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GameGenres"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameGenres"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<GameGenresQuery, GameGenresQueryVariables>;
export const GamePlatformsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GamePlatforms"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gamePlatforms"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<GamePlatformsQuery, GamePlatformsQueryVariables>;
export const GameCompanyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GameCompany"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameCompany"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"country"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"developed"}},{"kind":"Field","name":{"kind":"Name","value":"logo"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"published"}}]}}]}}]} as unknown as DocumentNode<GameCompanyQuery, GameCompanyQueryVariables>;
...
export const GamePreviewsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GamePreviews"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gamePreviews"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"game"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"video_id"}}]}}]}}]} as unknown as DocumentNode<GamePreviewsQuery, GamePreviewsQueryVariables>;
export const PopularGamesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PopularGames"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"popularGames"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<PopularGamesQuery, PopularGamesQueryVariables>;
export const TopRatedGamesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TopRatedGames"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"topRatedGames"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<TopRatedGamesQuery, TopRatedGamesQueryVariables>;
export const PopularGamesByGenreDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PopularGamesByGenre"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"genreId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"popularGamesByGenre"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"genreId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"genreId"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<PopularGamesByGenreQuery, PopularGamesByGenreQueryVariables>;
export const TopRatedGamesByGenreDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TopRatedGamesByGenre"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"genreId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"topRatedGamesByGenre"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"genreId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"genreId"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"age_ratings"}},{"kind":"Field","name":{"kind":"Name","value":"alternative_names"}},{"kind":"Field","name":{"kind":"Name","value":"artworks"}},{"kind":"Field","name":{"kind":"Name","value":"bundles"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"checksum"}},{"kind":"Field","name":{"kind":"Name","value":"collection"}},{"kind":"Field","name":{"kind":"Name","value":"collections"}},{"kind":"Field","name":{"kind":"Name","value":"cover"}},{"kind":"Field","name":{"kind":"Name","value":"coverUrl"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"dlcs"}},{"kind":"Field","name":{"kind":"Name","value":"expanded_games"}},{"kind":"Field","name":{"kind":"Name","value":"expansions"}},{"kind":"Field","name":{"kind":"Name","value":"external_games"}},{"kind":"Field","name":{"kind":"Name","value":"first_release_date"}},{"kind":"Field","name":{"kind":"Name","value":"forks"}},{"kind":"Field","name":{"kind":"Name","value":"franchise"}},{"kind":"Field","name":{"kind":"Name","value":"franchises"}},{"kind":"Field","name":{"kind":"Name","value":"game_engines"}},{"kind":"Field","name":{"kind":"Name","value":"game_localizations"}},{"kind":"Field","name":{"kind":"Name","value":"game_modes"}},{"kind":"Field","name":{"kind":"Name","value":"genres"}},{"kind":"Field","name":{"kind":"Name","value":"hypes"}},{"kind":"Field","name":{"kind":"Name","value":"involved_companies"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"language_supports"}},{"kind":"Field","name":{"kind":"Name","value":"multiplayer_modes"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"parent_game"}},{"kind":"Field","name":{"kind":"Name","value":"platforms"}},{"kind":"Field","name":{"kind":"Name","value":"player_perspectives"}},{"kind":"Field","name":{"kind":"Name","value":"ports"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"release_dates"}},{"kind":"Field","name":{"kind":"Name","value":"remakes"}},{"kind":"Field","name":{"kind":"Name","value":"remasters"}},{"kind":"Field","name":{"kind":"Name","value":"screenshots"}},{"kind":"Field","name":{"kind":"Name","value":"similar_games"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"standalone_expansions"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"storyline"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"tags"}},{"kind":"Field","name":{"kind":"Name","value":"themes"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating"}},{"kind":"Field","name":{"kind":"Name","value":"total_rating_count"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"version_parent"}},{"kind":"Field","name":{"kind":"Name","value":"version_title"}},{"kind":"Field","name":{"kind":"Name","value":"videos"}},{"kind":"Field","name":{"kind":"Name","value":"websites"}}]}}]}}]}}]} as unknown as DocumentNode<TopRatedGamesByGenreQuery, TopRatedGamesByGenreQueryVariables>;
export const GameCharactersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GameCharacters"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameCharacters"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"country_name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"games"}},{"kind":"Field","name":{"kind":"Name","value":"gender"}},{"kind":"Field","name":{"kind":"Name","value":"mug_shot"}},{"kind":"Field","name":{"kind":"Name","value":"mugShotUrl"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"species"}}]}}]}}]} as unknown as DocumentNode<GameCharactersQuery, GameCharactersQueryVariables>;
export const SearchGameCharactersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SearchGameCharacters"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchGameCharacters"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total_results"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"country_name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"games"}},{"kind":"Field","name":{"kind":"Name","value":"gender"}},{"kind":"Field","name":{"kind":"Name","value":"mug_shot"}},{"kind":"Field","name":{"kind":"Name","value":"mugShotUrl"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"species"}}]}}]}}]}}]} as unknown as DocumentNode<SearchGameCharactersQuery, SearchGameCharactersQueryVariables>;
...
export const UsersGameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UsersGame"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"usersGame"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"rating"}},{"kind":"Field","name":{"kind":"Name","value":"wishlist"}}]}}]}}]} as unknown as DocumentNode<UsersGameQuery, UsersGameQueryVariables>;
